        ...
        autenticacao.createUserWithEmailAndPassword(
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if( task.isSuccessful() ){
                    ...
                    usuario.setId( idenficadorUsuario );
                    usuario.salvar();

                    Preferencias preferencias = new Preferencias(CadastroUsuarioActivity.this);
                    preferencias.salvarDados(idenficadorUsuario, usuario.getNome());
                    ...
                    try{
                        ...
                        erroExcecao = "Difite uma senha mais forte, contendo mais caracteres e com letras e números!";
